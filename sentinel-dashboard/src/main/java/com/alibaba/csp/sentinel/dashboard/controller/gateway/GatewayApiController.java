...
public class GatewayApiController {
    ...
    private DynamicRuleProvider<List<ApiDefinitionEntity>> apiProvider;//添加我们自己写的ruleProvider

    @Autowired
    @Qualifier("getWayApiNacosPublisher")
    private DynamicRulePublisher<List<ApiDefinitionEntity>> apiPublisher;//添加我们自己写的rulePublisher
